<template>
  <div>
    <div class="p-fluid">
      <h1 class="h1_widget">Heatmap Analysis</h1>
      <Card>
            ...
            <div class="p-fluid p-formgrid p-grid p-jc-center">
              ...
              <div class="p-field p-col-3 p-sm-3">
                ...
                <Dropdown
                  ...
                  optionLabel="bubble_size"
                  placeholder="Select a Bubble Size"
                  :filter="true"
                  filterPlaceholder="Find available Parameters"
                  :showClear="true"
                />
  ...
  methods: {
    show_graph() {
      ...
      script.onload = () => {
        this.axios
          .get(
            "https://br-eam-backend.herokuapp.com/show_plotter/" +
    ...
    get_params() {
      this.axios
        .get(
          "https://br-eam-backend.herokuapp.com/get_params/" +
            this.selected_dataset
        )
        .then((res) => {
          ...
          for (let index = 0; index < res.data.bubble_size.length; index++) {
            this.bubble_size_options.push({
              bubble_size: res.data.bubble_size[index],
            });
          }
    ...
    send_inputs() {
      ...
      var user_input = {
        ...
        bubble_size_axis: this.bubble_size.bubble_size,
      ...
      this.axios
        .post(
          "https://br-eam-backend.herokuapp.com/post_inputs/" +
            this.selected_dataset +
            "/bubble_plotter",
          jsonString
        )
