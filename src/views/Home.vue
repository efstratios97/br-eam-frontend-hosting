            ...
            >
              ...
              <div class="hexagon-menu clear">
                <div class="hexagon-item">
                  ...
                  <router-link to="/usermanager" class="hex-content">
                ...
                <div class="hexagon-item">
                  ...
                  <router-link to="/cleanser" class="hex-content">
                    <span class="hex-content-inner">
                      <span class="icon">
                        <i class="glyphicon glyphicon-cog"></i>
                      </span>
                      <span class="title">Data Cleanser</span>
                    </span>
                    <svg
                      viewBox="0 0 173.20508075688772 200"
                      height="200"
                ...
                <div class="hexagon-item">
                  ...
                  <router-link to="/datahealthmanager" class="hex-content">
                    <span class="hex-content-inner">
                      <span class="icon">
                        <i class="glyphicon glyphicon-heart"></i>
                      </span>
                      <span class="title">Data Health</span>
                    </span>
                    <svg
                      viewBox="0 0 173.20508075688772 200"
                      height="200"
                ...
                <div class="hexagon-item">
                  ...
                  <router-link to="/datamanager" class="hex-content">
                    <span class="hex-content-inner">
                      <span class="icon">
                ...
                <div class="hexagon-item">
                  ...
                  <router-link to="/dataanalyzer" class="hex-content">
                    <span class="hex-content-inner">
                      <span class="icon">
                        <i class="glyphicon glyphicon-blackboard"></i>
                      </span>
                      <span class="title">Data Analyzer</span>
                    </span>
                    <svg
                      viewBox="0 0 173.20508075688772 200"
                      height="200"
